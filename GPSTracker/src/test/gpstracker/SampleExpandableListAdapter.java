...
public class SampleExpandableListAdapter extends BaseExpandableListAdapter implements ExpandableListAdapter  {
    ...
    public SampleExpandableListAdapter(Context context, Activity activity, List<SortedHistory> data) {
        this.data = data;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        View v = convertView;
        String child =((LocationItem) getChild(groupPosition, childPosition)).getLocationName();
        int id_res = 0; 
//        if(groupPosition == 0){ 
