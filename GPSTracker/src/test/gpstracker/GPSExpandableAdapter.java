...
public class GPSExpandableAdapter extends BaseExpandableListAdapter {
	private Context context;
    private CheckBox checkBox;
    private LayoutInflater inflater;
    private List<SortedHistory> data;
//    int _objInt;
...
//    public String []check_string_array;
    ...
    public GPSExpandableAdapter(Context context, Activity activity, List<SortedHistory> data) {
...
//    }
    public Object getChild(int groupPosition, int childPosition) {
        return data.get(groupPosition).getListLocationItems().get(childPosition);
    }
    ...
    public int getChildrenCount(int groupPosition) {
        return data.get(groupPosition).getListLocationItems().size();
    }
...
////       
//        if (child != null) {
//            v = layoutInflater.inflate(R.layout.child_item, null);
...
//        return v;
		...
		if (LocationItem.class.isInstance(getChild(groupPosition, childPosition))) {
			item = (LocationItem)getChild(groupPosition, childPosition);
		}
		else {
			Log.e("yen","bug");
		}
		if(view == null)
		{
			view = inflater.inflate(R.layout.child_item, null,false);
//			mHolder = new ViewHolderItem(view);
//			mHolder.text.setText(item.getLocationName());
//			
			view.setTag(mHolder);
		}
		else
...
//		if (data.get(groupPosition).getServices().get(childPosition)
//				.isChecked()) {
//			mHolder.img_check.setVisibility(View.VISIBLE);
//			
//		} else {
//			mHolder.img_check.setVisibility(View.GONE);
//		}
...
//       
//        if (group != null) {
//            v = inflater.inflate(GROUP_ITEM_RESOURCE, null);
//            ViewHolder holder = new ViewHolder(v);
//
...
//        return v;
    	...
    	ViewHolderGroup mHolder = null;
		View view = convertView;
		SortedHistory item =null;
		if (LocationItem.class.isInstance(getGroup(groupPosition))) {
			item = (SortedHistory)getGroup(groupPosition);
		}
		if(view == null)
		{
			view = inflater.inflate(R.layout.group_item, null, false);
//			view.setBackgroundColor(context.getResources().getColor(R.color.color_88888));
//			mHolder = new ViewHolderGroup(view);
//			mHolder.text.setText(item.date);
//			mHolder.text_name = (TextView) view
//					.findViewById(R.id.aa001_popup_service_item_text_name);
//			mHolder.btn_no_click = (Button) view.findViewById(R.id.button_no_click);
...
//			view.setTag(mHolder);
		...
		{
//			mHolder.text.setText(item.date);
//			mHolder = (ViewHolderGroup) view.getTag();
		}

		
//		mHolder.btn_no_click.setVisibility(View.VISIBLE);
//		mHolder.text_name.setText(data.get(groupPosition).getName());
